...
<!-- Document Title -->
<title>ODHIAMBO P1 INTRO TO SERVLETS</title>
      ...
      <div class="col-md-6">
        <ul class="row">
          <li class="margin-right-20">
            <p><i class="fa fa-envelope-o margin-right-10"></i>Info@davidodhiambo.com</p>
          </li>
          <li class="margin-right-20">
    ...
    <section class="padding-top-100 padding-bottom-100">
      <div class="container">
        ...
        <div class="text-center">
            ...
            <h1 class="text-uppercase letter-space-4 color-primary-pink margin-bottom-50">Sorry page not found</h1>
